...
class Dfql {
    ...
    static final String ID_NO_CLASSES = "43c81429-605c-43c9-a98e-0afc18f89bd0";
    static final String PS_NO_CLASSES = "" +
            "{\n" +
            "  \"apiVersion\": 0,\n" +
            "  \"classes\": {\n" +
            "    \n" +
    ...
    static final String ID_NES_COWS = "fab3866e-39f9-4c24-b7d3-11ee2b56bc3b";
    static final String PS_NES_COWS = "" +
            "{\n" +
            "  \"apiVersion\": 0,\n" +
            "  \"organization\": \"nes\",\n" +
            "  \"identifier\": \"mc-expo\",\n" +
